"""
Django settings for prd_training_ent_pr_45567 project.
...
ROOT_URLCONF = 'prd_training_ent_pr_45567.urls'
...
WSGI_APPLICATION = 'prd_training_ent_pr_45567.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_training_ent_pr_45567 API",
    "DESCRIPTION": "API documentation for prd_training_ent_pr_45567 App",
    "VERSION": "v1",
}
